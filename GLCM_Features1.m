...
% Contrast: matlab/[1,2]     2               (out.contr)
% Correlation: matlab                       (out.corrm)
% Correlation: [1,2]                        (out.corrp)
% Cluster Prominence: [2]     7              (out.cprom)
% Cluster Shade: [2]     6                   (out.cshad)
% Dissimilarity: [2]                        (out.dissi)
% Energy: matlab / [1,2]     3             (out.energ)
% Entropy: [2]       4                       (out.entro)
% Homogeneity: matlab      1                 (out.homom)
% Homogeneity: [2]     5                     (out.homop)
% Maximum probability: [2]     8             (out.maxpr)
...
%           f1. Uniformity / Energy / Angular Second Moment (done)  1
%           f2. Entropy (done)
%           f3. Dissimilarity (done)
%           f4. Contrast / Inertia (done)  1
%           f5. Inverse difference    
%           f6. correlation
%           f7. Homogeneity / Inverse difference moment  1
%           f8. Autocorrelation
%           f9. Cluster Shade
